 ...
 */
@Directive({
  selector: '[appChipListAutocompleteFix]',
})
export class ChipListAutocompleteFixDirective implements AfterContentInit {
  ...
  private rawInput: HTMLInputElement | undefined;
  ...
  private toggleInput() {
    ...
    console.warn(
      'You have not supplied a valid value for autocompleteInput. The fix will not work',
    );
  }
}
